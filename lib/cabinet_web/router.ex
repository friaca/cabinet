defmodule CabinetWeb.Router do
  ...
  scope "/", CabinetWeb do
    ...
    live "/locations/:id/add-product", LocationLive.Show, :new_product
    live "/locations/:id/edit-product/:product_id", LocationLive.Show, :edit_product
  end
  ...
  scope "/", CabinetWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{CabinetWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", CabinetWeb do
    ...
    live_session :current_user,
      on_mount: [{CabinetWeb.UserAuth, :mount_current_user}] do
